...
mod tests {
    ...
    fn test_artist_search_validation_success() {
        ...
        let mut args = CommandArgs::default();
        args.named.insert("query".to_string(), "Beatles".to_string());
    ...
    fn test_command_args_builder_pattern() {
        ...
        args.named.insert("artist".to_string(), "Radiohead".to_string());
        args.named.insert("limit".to_string(), "10".to_string());
        args.flags.insert("autocorrect".to_string(), true);
    ...
    fn test_get_required_arg_priority() {
        ...
        args.named.insert("artist".to_string(), "Named Artist".to_string());
    ...
    fn test_boolean_flag_handling() {
        ...
        assert_eq!(get_flag(&args, "autocorrect"), true);
        assert_eq!(get_flag(&args, "extended"), false);
        assert_eq!(get_flag(&args, "nonexistent"), false); // Default false
    }
