...
impl BaseCommand {
    pub fn new(name: impl Into<String>, description: impl Into<String>, api_client: Arc<dyn ApiClient>) -> Self {
        Self {
            name: name.into(),
...
impl CommandRegistry {
    ...
    pub fn with_defaults(api_client: Arc<dyn ApiClient>) -> Self {
        ...
        registry.register(Box::new(artist::ArtistSimilarCommand::new(api_client.clone())));
        registry.register(Box::new(artist::ArtistTopAlbumsCommand::new(api_client.clone())));
        registry.register(Box::new(artist::ArtistTopTracksCommand::new(api_client.clone())));
        registry.register(Box::new(artist::ArtistSearchCommand::new(api_client.clone())));
        ...
        registry.register(Box::new(track::TrackSimilarCommand::new(api_client.clone())));
        registry.register(Box::new(track::TrackSearchCommand::new(api_client.clone())));
        
        // Register chart commands
        registry.register(Box::new(chart::ChartTopArtistsCommand::new(api_client.clone())));
        registry.register(Box::new(chart::ChartTopTracksCommand::new(api_client.clone())));
        registry.register(Box::new(chart::ChartTopTagsCommand::new(api_client.clone())));
        ...
        registry.register(Box::new(user::UserTopArtistsCommand::new(api_client.clone())));
        registry.register(Box::new(user::UserRecentTracksCommand::new(api_client.clone())));
        
        // Register library commands
        registry.register(Box::new(library::LibraryArtistsCommand::new(api_client.clone())));
    ...
    pub fn with_defaults_and_auth(
        ...
        registry.register(Box::new(auth::AuthLoginCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(auth::AuthStatusCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(auth::AuthLogoutCommand::new(api_client.clone(), config_manager.clone())));
        
        // Register "my" commands for authenticated users
        registry.register(Box::new(my::MyRecentTracksCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(my::MyTopArtistsCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(my::MyTopTracksCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(my::MyTopAlbumsCommand::new(api_client.clone(), config_manager.clone())));
        registry.register(Box::new(my::MyInfoCommand::new(api_client.clone(), config_manager.clone())));
